            ...
            <div class="modal-body">
                <form class="form form-vertical">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group ">
                                    ...
                                    <div class="position-relative">
                                        <textarea rows="2" wire:model.debounce.1000ms='charge_message' type="text"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="store-btn btn btn-success"
                            wire:click.stop='chargeBalance()'>إضافة</button>
                    </div>
                </form>
            </div>
        </div>
