        ...
        <div class="card-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> أرصدة الوكلاء الفرعيين
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="buttons m-3">
                    ...
                    <a href="#" class="btn btn-danger btn-sm m-0 mx-1" wire:click.prevent='resetData'
                        data-bs-toggle="modal" data-bs-target="#withdrawBalanceModal">سحب رصيد</a>
                    <a href="#" class="btn btn-warning btn-sm m-0 mx-1"
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="d-flex align-items-baseline">
                        <h3 class="card-title me-5"> أرصدة الوكلاء الفرعيين</h3>
                        <div class="mb-1">
                    ...
                    @include('livewire.sub_agent_balance.charge_balance')
                    @include('livewire.sub_agent_balance.withdraw_balance')
                </div>
                ...
                <div class="card-content">
                    ...
                    <div class="table-responsive p-2">
                        <table class="table table-responsive-sm">
                            ...
                            <tbody>
                                @forelse($agentChargingBalance as $item)
                                    <tr>
