<div>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="createUserModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <h6>الصلاحيات</h6>
                                    <fieldset class="form-group">
                                        <select wire:model='permission' class="form-select" id="basicSelect">
                                            <option>- إختيار - </option>
