<div>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="updateAgentModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> تعديل بيانات الوكيل الفرعي</h5>
                        ...
                        <div class="form-body">
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <fieldset class="form-group">
                                    <select wire:model.debounce='permission' class="form-select" id="basicSelect"
                                        disabled>
                                        <option>- إختيار - </option>
                                        <option value="1">يمكنه إضافة عميل</option>
                                        <option value="2">لا يمكنه إضافة عميل</option>
                                    </select>
                                </fieldset>
                                @error('permission')
                                    <span class="text-danger d-block mt-2">{{ $message }}</span>
