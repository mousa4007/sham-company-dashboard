<div>
        ...
        <div class="card-content">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">منتجات االتحويل اليدوي</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="buttons m-3">
                    <a href="#" class="btn btn-primary btn-sm m-0 mx-1" wire:click.prevent='resetData'
                        data-bs-toggle="modal" data-bs-target="#createTransferProudctModal">إضافة</a>
                    <a href="#" class="btn btn-danger btn-sm m-0 mx-1" data-bs-toggle="modal"
                        data-bs-target="#deleteTransferProudctModal">حذف</a>
    ...
    @include('livewire.transfer_product.create_transfer_product')
    ...
    <div class="row" id="table-striped">
        <div class="col-12">
            <div class="card">
                ...
                @include('livewire.transfer_product.delete_transfer_product')
                @include('livewire.transfer_product.update_transfer_product')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button"class="btn btn-sm btn-info" data-bs-toggle="modal"
                                                data-bs-target="#updateTransferProudctModal"
