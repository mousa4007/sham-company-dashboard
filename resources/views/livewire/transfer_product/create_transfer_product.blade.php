<div>
    <div wire:ignore.self class="modal fade" id="createTransferProudctModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                ...
                <form class="form form-vertical">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-icon-left">
                                    <label for="first-name-icon" class="mb-2">التلميح</label>
                                    <div class="position-relative">
                                        <input wire:model.defer='hintMessage' type="text"
                                            class="form-control @error('hintMessage') is-invalid @enderror"
                                            placeholder="التلميح الذي يظهر بالتطبيق" id="first-name-icon" required>
                                        <div class="form-control-icon">
                            ...
                            <div class="col-md-6 mb-0">
                                <label for="first-name-icon" class="d-block mb-2">نوع الدخل</label>
                                <fieldset class="form-group">
                                    <select wire:model='dataType' class="form-select" id="basicSelect">
                                        <option value="0">نص</option>
                                        <option value="1">فقط أرقام</option>
                                    </select>
                                </fieldset>
                                @error('dataType')
                                    <span class="text-danger d-block mt-2">{{ $message }}</span>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" wire:click='store'>إضافة</button>
                    </div>
                </form>
            </div>
        </div>
