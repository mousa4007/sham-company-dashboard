<div>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="acceptedTransferProductModal" tabindex="-1"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">منتجات التحويل اليدوي المقبولة</h5>
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="d-flex align-items-baseline">
                                            <h3 class="card-title me-5">منتجات التحويل اليدوي المقبولة</h3>
                                            <div class="mb-1">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="table-responsive p-2">
                                            <table class="table table-bordered ">
                                                ...
                                                <tbody>
                                                    @forelse ($acceptedTransferProducts as  $item)
                                                        <tr>
                                            ...
                                            <div class="my-3">
                                                {{ $acceptedTransferProducts->links() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
